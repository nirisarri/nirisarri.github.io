...
##_you should never have Read/Write access to prod!_
...
Looking for a way to circumvent this I found another strategy for seeding and user creation. It came after reading the mongoDb documentation for its container, in https://hub.docker.com/_/mongo .
